    ...
    <Section class="bg-primary container-fluid">
        ...
        <div class="row">
            ...
            <section class="col-md-4">
                <div class="navbar " >
                    <ul class="nav">
                        <li class="nav-item btn btn-active">
...
<div class="w-75 mx-auto mt-5 ">
    <div class=" mx-auto my-5 text-center"> 
        <h1>
            Select a User you want to <em>transfer as</em>!!
        </h1>
    </div>
<div class="search-box rounded" style="margin-left: 25%; margin-bottom: 25px;">
  	  	...
  	  	<td><?php echo $row['balance'];?></td>
                ...
                <td>
                    <button class="btn btn-primary text-center"  >
                        <a class="nav-link text-light" href="transfer.php?id=<?php echo $row['id'];?>"><em class="	fas fa-user-alt" aria-hidden="true"></em>
                        Select
                        </a>
                    </button>
                </td>
